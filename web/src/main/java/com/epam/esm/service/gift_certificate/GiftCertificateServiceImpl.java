...
public class GiftCertificateServiceImpl implements GiftCertificateService {
    ...
    public BaseResponseDto<GiftCertificateDto> create(GiftCertificateDto giftCertificateDto) {
        ...
        GiftCertificate create = giftCertificateDAO.save(modelMapper.map(giftCertificateDto, GiftCertificate.class));
        if (create != null) {
    ...
    public BaseResponseDto delete(UUID certificateId) {
        int delete = giftCertificateDAO.remove(certificateId);
        if (delete == 1) {
